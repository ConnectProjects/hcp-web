...
export function renderTestEntry(container, state, navigate) {
  ...
  container.innerHTML = `
    <div class="tech-tool-container">
      ...
      <h2 class="section-title">Noise Exposure & Hearing Conservation</h2>
      <div class="form-card">
          <div class="q-row">
            <span class="q-label">Have you been exposed to noise within the last two hours?</span>
            <select class="q-input q-select" id="exposed_2hr" data-id="exposed_2hr">
                <option value="No" ${slot.testData.exposed_2hr === 'No' ? 'selected' : ''}>No</option>
                <option value="Yes" ${slot.testData.exposed_2hr === 'Yes' ? 'selected' : ''}>Yes</option>
            </select>
          </div>
          <div class="sub-question ${slot.testData.exposed_2hr === 'Yes' ? 'visible' : ''}" id="exposed_2hr_details">
            <div class="q-row no-border">
                <span class="q-label">If yes, then how long?</span>
          ...
          <div class="q-row">
            <span class="q-label">Do you regularly wear hearing protection in noisy areas?</span>
      ...
      <!-- 3. Noise & Hearing History Section -->
      ...
      <div class="form-card">
          ...
          <div class="sub-question ${slot.testData.ringing === 'Yes' ? 'visible' : ''}" id="ringing_details">
            <div class="q-row no-border">
                <span class="q-label">Ear & Duration (Years)</span>
                <div style="display:flex; gap:10px;">
                    ...
                    <select class="q-input q-select" data-id="ringing_duration">
                        <option value="less than 5" ${slot.testData.ringing_duration === 'less than 5' ? 'selected' : ''}>less than 5</option>
                        <option value="5-10" ${slot.testData.ringing_duration === '5-10' ? 'selected' : ''}>5-10</option>
                        <option value="11-15" ${slot.testData.ringing_duration === '11-15' ? 'selected' : ''}>11-15</option>
                        <option value="over 15" ${slot.testData.ringing_duration === 'over 15' ? 'selected' : ''}>over 15</option>
                    </select>
                </div>
            </div>
          </div>
      ...
      <div class="audio-entry-container">
          <div style="flex:1">
              ...
              <div class="audio-input-row">
                  ${[500, 1000, 2000, 3000, 4000, 6000, 8000].map(f => renderAudioInput('L', f, slot.testData['left_'+(f>=1000?f/1000+'k':f)])).join('')}
              </div>
          ...
          <div style="flex:1">
              ...
              <div class="audio-input-row">
                  ${[500, 1000, 2000, 3000, 4000, 6000, 8000].map(f => renderAudioInput('R', f, slot.testData['right_'+(f>=1000?f/1000+'k':f)])).join('')}
              </div>
