...
export function renderTestEntry(container, state, navigate) {
  ...
  // 2. Safety Check: If no employee is loaded, go back
  if (!emp) {
  ...
  container.innerHTML = `
    ...
    <div class="tech-tool-container">
      ...
      <div class="q-row">
        <div class="q-label">Do you regularly wear hearing protection?</div>
      ...
      <div class="sub-question" id="hpd_details">
        <div style="display:flex; gap:20px;">
            ...
            <select class="q-input q-select" data-id="hpd_style" style="width:100%"><option value="earplugs">Earplugs</option><option value="earmuffs">Earmuffs</option><option value="custom">Custom</option></select>
        </div>
      </div>
      ...
      <div class="sub-question" id="ringing_details">
        <div style="display:flex; gap:20px;">
            ...
            <select class="q-input q-select" data-id="ringing_duration" style="width:100%"><option value="less than 5">less than 5</option><option value="over 15">over 15</option></select>
        </div>
      </div>
...
function updateAudiogramPlot(container, ear, baseline) {
    ...
    if (baseline && baseMarkers.innerHTML === '') {
        ...
        freqs.forEach((f, i) => {
            ...
            const val = source[Object.keys(source).find(k => k.toLowerCase() === key.toLowerCase())];
